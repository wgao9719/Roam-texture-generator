                ...
                >
                  {loading || imageLoading ? (
                    <span className="flex items-center">
                      ...
                      {loading ? 'Generating...' : 'Loading image...'}
                    </span>
                  ) : 'Generate Image'}
                </button>
              </form>
                        ...
                        newWindow.document.write(`
                          <html>
                            <head>
                              ...
                              <style>
                                body { margin: 0; background: #f5f5f5; height: 100vh; display: flex; align-items: center; justify-content: center; }
                                img { max-width: 95vw; max-height: 95vh; object-fit: contain; }
                              </style>
                            </head>
                            <body>
                              <img src="${result}" alt="Full size image">
                            </body>
                          </html>
                        `);
                      }
                ...
                <p className="text-gray-500 text-center">
                  {loading || imageLoading ? (
                    <span className="flex flex-col items-center">
                      ...
                      {loading ? 'Generating your texture...' : 'Loading image...'}
                    </span>
                  ) : (
